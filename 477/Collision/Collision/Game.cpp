...
void Game::_loadData() {
    ...
    //Test AIComponent and AIState
    AIComponent* pAIC = new AIComponent(temp);
    pAIC->RegisterState(new AIPatrol(pAIC));
    pAIC->RegisterState(new AIAttack(pAIC));
    pAIC->ChangeState("Patrol");
}
