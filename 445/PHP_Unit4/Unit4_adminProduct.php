...
<html>
<style>
    <?php include 'Unit4_adminProduct.css'; ?>
</style>
...
<script>
    ...
    function createPart(){
        if(checkForm()){
            ...
            xhttp.open("POST", "Unit4_create.php?q="+pname+"&image="+pimage+"&quantity="+quantity+"&price="+price+"&inactive="+inactive.checked);
            xhttp.send(); 
        }
    }
    function updatePart(){
        ...
        xhttp.open("POST", "Unit4_update_product.php?q="+pname+"&image="+pimage+"&quantity="+quantity+"&price="+price+"&inactive="+inactive.checked+"&oldname="+oldname);
        xhttp.send(); 
    }
    }
    ...
    function deletePart(){
        if(window.confirm("Are you sure you want to delete this product?")){
            ...
            xhttp.open("POST", "Unit4_delete_product.php?q="+pname);
            xhttp.send(); 
        }
    }
    ...
    function checkForOrder(){
        ...
        xhttp.open("POST", "Unit4_check_order.php?q="+pname);
        xhttp.send(); 
    }
    }
