...
public:
    ...
    */
    ...
    /*
        previous_queue:
            keeps track of the threads previous queue for MLFQ
    */
    int previous_queue = 0;

    /*
        queue_service_time:
            time thread has spent in current queue for MLFQ
    */
   int queue_service_time = 0;
   
   /*
        vruntime:
           virtual runtime of a task (CFS)
    */
   int vruntime = 0;
