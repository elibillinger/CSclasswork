...
int main() {
    ...
    while (true) {
        ...
        int word_length = game.get_word_length("How long of a word would you like?");
        cout << endl;

        //bool running_words = get_yesno("Show running total of words (y/n)?");
        bool running_words = false;

        game.start_new_game(num_guesses,word_length,running_words);
