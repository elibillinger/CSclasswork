...
<script>
    ...
    function getCookie(){
        ...
        var value = JSON.parse(cookiePair[1]);
        $("#customer").html("Based on your viewing history we'd like to offer 20% off these items:");
        let list = document.getElementById("viewedList");
        value.forEach((item) => {
            let li = document.createElement("li");
            li.innerText = item;
            list.appendChild(li);
        });
        document.getElementById("viewedList").style.color = "blue";
        document.getElementById("customer").style.color = "blue";
    }
</script>
</body>
</html>